...
> {
  ...
  constructor(
    @inject('datasources.PostgresqlDS') dataSource: PostgresqlDsDataSource, @repository.getter('VentaRepository') protected ventaRepositoryGetter: Getter<VentaRepository>,
  ) {
